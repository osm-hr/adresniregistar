...
<br/>
<p>Ovdje možete vidjeti sve adrese u OpenStreetMap-ama koje nemaju ref:HR:kucni_broj oznaku, po općinama.
...
<tbody>
	...
	<tr>
		<td><a href="osm_addresses/{{ opstina.name }}.html">{{ opstina.name }}</a></td>
		<td>{{ opstina.count }}</td>
	</tr>
	{% endfor %}
</tbody>
