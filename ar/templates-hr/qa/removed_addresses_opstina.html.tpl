      ...
      <div class="modal-header">
        ...
        <div class="modal-body">
            <ul>
                ...
                <li><b>„removed:ref:HR:kucni_broj” tag</b> &mdash; „removed:ref:HR:kucni_broj” oznaka na adresi, vrijednost koju je adresa nekad imala u DGU-u</li>
                <li><b>„ref:HR:kucni_broj” tag</b> &mdash; „ref:HR:kucni_broj” oznaka na adresi, ukoliko trenutno postoji. Ako postoje obe vrijednosti, treba obrisati „removed:ref:HR:kucni_broj” oznaku</li>
            </ul>
        </div>
...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item" aria-current="page"><a href="../removed_addresses.html">Obrisane DGU adrese</a></li>
...
<br/>
<p>Ovdje možete vidjeti sve DGU adrese koje smo uneli u OSM, ali su one od tad izbrisane iz DGU-a.
    ...
    Ukoliko postoji „removed:ref:HR:kucni_broj” oznake, sigurno treba obrisati „removed:ref:HR:kucni_broj” oznaku!
...
<thead class="thead-dark sticky-top">
	<tr>
        ...
        <th>„removed:ref:HR:kucni_broj” tag</th>
        <th>„ref:HR:kucni_broj” tag</th>
	</tr>
</thead>
<tbody>
