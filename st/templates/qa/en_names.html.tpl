...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
	...
	<li class="breadcrumb-item" aria-current="page">Engleski nazivi</li>
  </ol>
</nav>
    <!-- Optional JavaScript -->
...
<tbody>
	...
	<tr>
		<td><a href="en_names/{{ opstina.name }}.html">{{ opstina.name }}</a></td>
		<td>{{ opstina.unneeded_name_en }}</td>
		<td>{{ opstina.suspicious_name_en }}</td>
	</tr>
	{% endfor %}
</tbody>
<tfoot>
	<tr>
		<th>Serbia TOTAL:</th>
		<th class="d-sm-table-cell">{{ total.unneeded_name_en }}</th>
		<th class="d-sm-table-cell">{{ total.suspicious_name_en }}</th>
	</tr>
</tfoot>
</table>
