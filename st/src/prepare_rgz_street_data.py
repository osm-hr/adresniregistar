...
if __name__ == '__main__':
    ...
    parser.add_argument('--output-csv-file', default=None, required=True, help='Output CSV file for all DGU streets')
    parser.add_argument('--output-csv-folder', default=None, required=True, help='Output directory for DGU streets per municipality')
