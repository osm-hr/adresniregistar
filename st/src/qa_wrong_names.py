...
#check_alt_name("Првог маја 3. део", "Првог маја 3. део", "1. маја 3. део", False)
#a = check_alt_name("15. октобра", "15. октобра", None, False)
...
def find_wrong_names(cwd, street_mappings: StreetMapping):
    ...
    df_osm_streets = df_osm_streets[~df_osm_streets.osm_id.isin([
        ...
        'w1076701917', 'w1076701916', 'w1076701915', 'w1076701914', 'w1076701913', 'w1076701911', 'w1076701910',  # NOMAD camp
        'r16764149'])]
    ...
    streets_per_opstina = streets_per_opstina.merge(df_rgz_streets[['rgz_opstina', 'rgz_ulica_mb', 'rgz_ulica']], how='left', left_on='ref:HR:ulica', right_on='rgz_ulica_mb')
    ...
    # streets_per_opstina = pd.read_csv('~/src/adresniregistar/st/data/qa/addresses_per_opstina.csv', dtype={'ref:HR:ulica': 'string'})
