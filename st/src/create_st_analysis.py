...
def do_analysis(opstina, data_path, street_mappings: StreetMapping, df_cached_circles):
    ...
    print(f"    Joining streets in DGU and OSM in {opstina} by conflation (ref:RS:ulica)")
    ...
    # TODO: do quality checks for alt_name, short_name
...
def process_all_opstina(data_path, osm_csv_path, rgz_csv_path, street_mappings, df_cached_circles):
